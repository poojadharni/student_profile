<template>
  <div class="min-h-screen bg-[#f5f7fb] p-2 md:p-4">
    ...
    <div class="mt-3">
      ...
      <div class="bg-white border rounded-xl p-4 shadow-sm">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-3">
          ...
          <div v-for="notification in notifications" :key="notification.id" @click="openNotification(notification)"
    ...
    <!-- MODAL -->
    <div v-if="showModal" class="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 px-3">
